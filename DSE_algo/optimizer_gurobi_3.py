from resourceILPBuilder_gurobi_2 import resourceILPBuilder
...
class optimizer:
    def __init__(self, BRAM_budget, DSP_budget, FF_budget, LUT_budget, 
        ...
        self.g = graph(app_fileName, self.explore_IP_types)
...
#            self.g.drawGraph()
    ...
    def assignMappingResult(self):
        for g in self.rb.mappingVariables:
            for layer_type in self.rb.mappingVariables[g]:
                variables = self.rb.mappingVariables[g][layer_type]
