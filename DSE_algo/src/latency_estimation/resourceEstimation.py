...
def resource_estimate_convolution_group(iBufferSize, oBufferSize, wBufferSizei, ker_proc, pix_proc):
    inBrams = ceil(iBufferSize*2/1024.0) * 8 * 2 * ceil(32.0/18)
    outBrams = ceil(oBufferSize*2/1024.0) * 8 * ceil(72.0/18) * 2
    wBrams = ceil(wBufferSizei / 1024.0) * ker_proc * ceil(32.0/18) * 2
    feedingBrams = ceil(32.0/18) * pix_proc/2 * 2
    resulting = ker_proc * 2 * 2
    bias_scale = 24
