...
int ConvolutionPipeWrapper(	int *  MemArgs,
...
void PipeForward(
	...
	long long int start =sds_clock_counter();
    long long int frequency = sds_clock_frequency();
	ConvolutionPipeWrapper(
		(int *)  MemArgs,
		(ap_uint<128> *)  IP121_M_out0,
		(ap_uint<128> *)  IP121_M_out1,
		(ap_uint<128> *)  IP18_2_M_in0,
	...
	sds_wait(1);
	long long int end =sds_clock_counter();
		...
		int *scalar_conv_args )
{
	...
	{
// std::cout<<"calling function"<<scalar_conv_args[12]<<endl;
